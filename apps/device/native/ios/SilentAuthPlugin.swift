...
/**
 * Reference / sync copy of TrustIdSilentAuthPlugin.
 * Canonical: apps/device/ios/App/App/plugins/SilentAuthPlugin.swift
 */
...
public class TrustIdSilentAuthPlugin: CAPPlugin, CAPBridgedPlugin {
  ...
  private func exportSpki(_ key: SecKey) throws -> String {
    ...
    var bitString = Data([0x03, UInt8(data.count + 1), 0x00])
